...
export default function SignUpPage({ onSignUp, onNavigateToLogin }: SignUpPageProps) {
  // Theme state (synchronized with dailycruit_theme)
  ...
  const getPasswordStrength = () => {
    ...
    // Cap at max 4 score, but give 1 baseline if typed anything at all
  ...
  //handle submit using Firebase authentication 
      ...
      <div className={`auth-card-wrapper ${shake ? "auth-shake" : ""}`}>
        <div className="auth-card" style={{ maxWidth: "480px" }}>
          ...
          <div className="auth-header">
            ...
            <p>Get started with Daily-Cruit recruiter and seeker tools</p>
          </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="auth-field-group">
              ...
              {errors.name && (
                <div id="name-error" className="auth-error-msg" role="alert">
              ...
              {password.length > 0 && (
                <div>
                  <div className="auth-strength-meter">
                    <div className={`auth-strength-bar ${strength.score >= 1 ? `filled-${strength.className}` : ""}`} />
                    <div className={`auth-strength-bar ${strength.score >= 2 ? `filled-${strength.className}` : ""}`} />
                    <div className={`auth-strength-bar ${strength.score >= 3 ? `filled-${strength.className}` : ""}`} />
                    <div className={`auth-strength-bar ${strength.score >= 4 ? `filled-${strength.className}` : ""}`} />
                  </div>
                  <span className={`auth-strength-text ${strength.className}`}>
            ...
            <div className="auth-field-group">
              ...
              {errors.confirmPassword && (
                <div id="confirm-password-error" className="auth-error-msg" role="alert">
            ...
            <div className="auth-field-group" style={{ marginBottom: "24px" }}>
              <label className="auth-remember-label" style={{ alignItems: "flex-start" }}>
                <input
                  type="checkbox"
                ...
                <span style={{ fontSize: "12px", lineHeight: "1.4" }}>
                  I agree to the <a href="#terms" onClick={(e) => { e.preventDefault(); showToast("Terms clicked."); }} style={{ color: "#22c55e", textDecoration: "none", fontWeight: 550 }}>Terms of Service</a> and <a href="#privacy" onClick={(e) => { e.preventDefault(); showToast("Privacy clicked."); }} style={{ color: "#22c55e", textDecoration: "none", fontWeight: 550 }}>Privacy Policy</a>
                </span>
              </label>
              {errors.terms && (
